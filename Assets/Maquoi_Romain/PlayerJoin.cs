...
public class PlayerJoin : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //if (_numPlayers == 0)
        //{
        //    _p1 = PlayerInput.Instantiate(_playerT, _numPlayers, controlScheme: "Gamepad", pairWithDevice: Gamepad.all[0]);
        ...
        //{
        //    _p2 = PlayerInput.Instantiate(_playerT, _numPlayers, controlScheme: "Gamepad", pairWithDevice: Gamepad.all[1]);
